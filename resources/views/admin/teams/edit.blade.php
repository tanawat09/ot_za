...
@section('header', 'แก้ไขทีม (Edit Team)')
    ...
    <div class="col-md-8 col-lg-6">
        <div class="card card-custom p-4">
            <h5 class="fw-bold font-heading mb-4 border-bottom pb-2">
                <i class="bi bi-pencil-square text-primary me-2"></i>แก้ไขทีม: {{ $team->name_th }}
            </h5>
            ...
            <form method="POST" action="{{ route('admin.teams.update', $team) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name_th') is-invalid @enderror" id="name_th" name="name_th" value="{{ old('name_th', $team->name_th) }}" required>
                    @error('name_th')
                        <div class="text-danger fs-7 mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-4 form-check">
                    <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" {{ old('is_active', $team->is_active) ? 'checked' : '' }}>
